...
import { getProductCategories } from "../controllers/productCategoryControllers/getProductCategories.js";
import { getProductCategory } from "../controllers/productCategoryControllers/getProductCategory.js";

const productCategoryRoute = Router();

productCategoryRoute.get("/:id", getProductCategory);
